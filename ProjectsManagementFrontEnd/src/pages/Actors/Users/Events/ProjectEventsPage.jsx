...
function ProjectEventsPage() {
  ...
  const { projectEvents, projectEventsError, loading } = useSelector(
  ...
  //haddle errors
  // useEffect(() => {
  //   if (!loading && projectEventsError !== "") {
  //     navigate("/error", { state: { projectEventsError } });
  //   }
  // }, [loading, projectEventsError]);
