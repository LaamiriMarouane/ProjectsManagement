...
public enum Permission {
    ...
    PROJECT_OWNER_READ("projectOwner:read"),
    PROJECT_OWNER_UPDATE("projectOwner:update"),
    PROJECT_OWNER_CREATE("projectOwner:create"),
    PROJECT_OWNER_DELETE("projectOwner:delete"),
